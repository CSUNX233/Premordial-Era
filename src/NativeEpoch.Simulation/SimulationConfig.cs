...
public sealed record SimulationConfig
{
    ...
    public double MovementEnergyPerDistance { get; init; } = 0.0053;
    public double ActiveSurfaceDriveSpeed { get; init; } = 12.0;
    public double ActiveSurfaceDriveEnergyScale { get; init; } = 0.0003;
    ...
    public double ForagingRestEnergyFraction { get; init; } = 0.01;
    ...
    public double ContestEnergyPerForceSecond { get; init; } = 0.002;
    public double ReproductionBlockedRetrySeconds { get; init; } = 1.5;
    public double ReproductionEnergyCost { get; init; } = 0.9;
    ...
    public double LocalActuationEnergyScale { get; init; } = 0.006;
    public double SecretionMatterPerSecond { get; init; } = 0.006;
    public double SecretionEnergyPerMatter { get; init; } = 0.027;
    ...
    public double DehydrationEnergyCostPerSecond { get; init; } = 0.025;
    public double PressureMismatchEnergyCostPerSecond { get; init; } = 0.0017;
